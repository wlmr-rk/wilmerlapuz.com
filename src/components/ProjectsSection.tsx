...
const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription:
      "A command-line utility built in Rust that automates the management of NixOS system configurations, dotfiles synchronization, and development environment setup.",
    technologies: ["Rust", "Clap", "Tokio", "Serde", "Git"],
    category: "Tool",
    status: "In Progress",
  ...
  },
  {
    ...
    description:
      "Automated data collection and processing system for personal metrics",
    longDescription:
      "A robust system that automatically collects data from various APIs, processes it, and generates insights. Built with error handling, retry mechanisms, and monitoring.",
    technologies: [
      "Node.js",
      "TypeScript",
      "GitHub Actions",
