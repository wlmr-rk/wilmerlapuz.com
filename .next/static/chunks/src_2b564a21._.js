...
"[project]/src/components/MobileNavigation.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const MobileNavigation = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MobileNavigation.useEffect": ()=>{
            const handleScroll = {
                "MobileNavigation.useEffect.handleScroll": ()=>{
                    setShowScrollTop(window.scrollY > 200);
                    const sections = navItems.map({
                        "MobileNavigation.useEffect.handleScroll.sections": (item)=>document.getElementById(item.id)
                    }["MobileNavigation.useEffect.handleScroll.sections"]);
            ...
            window.addEventListener("scroll", handleScroll);
            return ({
                "MobileNavigation.useEffect": ()=>window.removeEventListener("scroll", handleScroll)
            })["MobileNavigation.useEffect"];
        }
    }["MobileNavigation.useEffect"], []);
    const scrollToSection = (href)=>{
...
_s(MobileNavigation, "+8iQKSQEFUcLVd5u1UAGFo+ikx0=");
_c = MobileNavigation;
                                ...
                                children: skills.map((skillGroup)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "space-y-2",
                                                children: skillGroup.items.map((skill)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ProjectsSection, "spzPLqogq+DjC3qyUI1pws6onwQ=");
_c = ProjectsSection;
...
"[project]/src/hooks/useStats.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useStats = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useStats.useEffect": ()=>{
            const fetchStats = {
                "useStats.useEffect.fetchStats": async ()=>{
                    try {
                        setLoading(true);
                        ...
                        const [wakatimeRes, stravaRes, spotifyRes, leetcodeRes, ankiRes] = await Promise.all([
                            fetch("/wakatime-data.json").catch({
                                "useStats.useEffect.fetchStats": ()=>null
                            }["useStats.useEffect.fetchStats"]),
                            fetch("/strava-data.json").catch({
                                "useStats.useEffect.fetchStats": ()=>null
                            }["useStats.useEffect.fetchStats"]),
                            fetch("/spotify-data.json").catch({
                                "useStats.useEffect.fetchStats": ()=>null
                            }["useStats.useEffect.fetchStats"]),
                            fetch("/leetcode-data.json").catch({
                                "useStats.useEffect.fetchStats": ()=>null
                            }["useStats.useEffect.fetchStats"]),
                            fetch("/anki-data.json").catch({
                                "useStats.useEffect.fetchStats": ()=>null
                            }["useStats.useEffect.fetchStats"])
                        ]);
                        const statsData = {
            ...
            return ({
                "useStats.useEffect": ()=>clearInterval(interval)
            })["useStats.useEffect"];
        }
    }["useStats.useEffect"], []);
    return {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useStats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useStats.ts [app-client] (ecmascript)");
...
const StatsSection = ()=>{
    _s();
    const { stats, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useStats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStats"])();
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
            id: "stats",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            stats?.wakatime && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: stats.anki.decks.slice(0, 5).map((deck)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(StatsSection, "llV15gvN28mlqFVx88KvSW0J3Ts=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useStats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStats"]
    ];
});
_c = StatsSection;
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                                ...
                                                children: [
                                                    ...
                                                    status.type !== "idle" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ContactSection, "5sjb7iLmoe2Yl7engRUpY/V+7kQ=");
_c = ContactSection;
...
//# sourceMappingURL=src_2b564a21._.js.map