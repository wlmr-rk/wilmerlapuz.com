        ...
        <div class="mt-12">
          ...
          <div class="flex justify-center gap-6">
            <a
              ...
              class="group flex items-center gap-2 bg-slate-900/30 border border-slate-800 rounded px-4 py-2 hover:border-blue-500 hover:bg-slate-800/50 transition-all duration-300"
            >
              <svg
              ...
              <span
                class="text-slate-300 group-hover:text-blue-400 transition-colors font-mono text-sm"
                >github</span
              >
            </a>
            <a
